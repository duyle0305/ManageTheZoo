...
public class AnimalType {
    ...
    public static final int ZLA = 1, BFLA = 2;
    ...
    public AnimalType(int typeCode, String desc, int numLegs, int numSwings, String movingMethod, boolean canFly, boolean canSing, boolean canGrowl, String food, double maxWeight) {
    ...
    public String toString() {
        return "AnimalType{" + "desc=" + desc + ", numLegs=" + numLegs + ", numSwings=" + numSwings + ", movingMethod=" + movingMethod + ", canFly=" + canFly + ", canSing=" + canSing + ", canGrowl=" + canGrowl + ", food=" + food + ", maxWeight=" + maxWeight + '}';
    }
